...
int main(int argc, char** argv) {
  ...
  ma2_cmd->add_option("--format", ma2_format_str, "simai|simai-fes|ma2-103|ma2-104");
  ...
  simai_cmd->add_option("--format", simai_format_str, "simai|simai-fes|ma2-103|ma2-104");
  ...
  auto* assets_diff_opt =
      assets_cmd->add_option("--difficulty", assets_difficulty,
                             "Difficulty 0..7 (optional, with --id set and no --difficulty export all difficulties)")
          ->check(CLI::Range(0, 7));
  ...
  assets_cmd->add_option("--format", assets_format_str, "simai|simai-fes|ma2-103|ma2-104");
