...
std::optional<ChartFormat> parse_chart_format(const std::string &value) {
  ...
  static const std::unordered_map<std::string, ChartFormat> kMap = {
      {"simai", ChartFormat::Simai},       {"simai-fes", ChartFormat::SimaiFes},
      {"simaifes", ChartFormat::SimaiFes}, {"maidata", ChartFormat::Maidata},
      {"ma2", ChartFormat::Ma2_103},       {"ma2-103", ChartFormat::Ma2_103},
      {"ma2_103", ChartFormat::Ma2_103},   {"ma2-104", ChartFormat::Ma2_104},
