			...
			{
				{
					...
					memcpy((void*)pPreloadTable->Get(i)->Get(0U)->GetValue(), &valueTmp, sizeof(AssetTypeValue));
				}
				{
					...
					memcpy((void*)pPreloadTable->Get(i)->Get(1)->GetValue(), &valueTmp, sizeof(AssetTypeValue));
				}
			}
		}
			...
			{
				{
					...
					memcpy((void*)pContainerTable->Get(i)->Get(0U)->GetValue(), &valueTmp, sizeof(AssetTypeValue));
				}
				{
					...
					memcpy((void*)pContainerTable->Get(i)->Get(1)->Get(0U)->GetValue(), &valueTmp, sizeof(AssetTypeValue));
				}
				{
					AssetTypeValue valueTmp = AssetTypeValue(
						pContainerTable->GetTemplateField()->children[1].children[1].children[1].valueType, &containerArray[i].preloadSize);
					memcpy((void*)pContainerTable->Get(i)->Get(1)->Get(1)->GetValue(), &valueTmp, sizeof(AssetTypeValue));
				}
				{
					AssetTypeValue valueTmp = AssetTypeValue(
						pContainerTable->GetTemplateField()->children[1].children[1].children[2].children[0].valueType, &containerArray[i].ids.fileId);
					memcpy((void*)pContainerTable->Get(i)->Get(1)->Get(2)->Get(0U)->GetValue(), &valueTmp, sizeof(AssetTypeValue));
				}
				{
					AssetTypeValue valueTmp = AssetTypeValue(
						pContainerTable->GetTemplateField()->children[1].children[1].children[2].children[1].valueType, &containerArray[i].ids.pathId);
					memcpy((void*)pContainerTable->Get(i)->Get(1)->Get(2)->Get(1)->GetValue(), &valueTmp, sizeof(AssetTypeValue));
				}
			}
		}
	}
